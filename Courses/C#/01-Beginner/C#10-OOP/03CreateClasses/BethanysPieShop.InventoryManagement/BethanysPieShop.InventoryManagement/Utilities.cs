    ...
    internal class Utilities
    {
        ...
        internal static void InitializeStock()//Mock implementation
        {
            BoxedProduct boxedProduct = new BoxedProduct(
                6, "Eggs", "Lorem ipsum", new Price() { ItemPrice = 10, Currency = Currency.Euro }, 100, 6);
            ...
            //p1.UseProduct(10);
            //p2.UseProduct(5);
            //Neither BoxedProduct or FreshProduct has implementation for UseProduct()
            //Both invoke UseProduct() on the base class. 

            //Polymorphism in action
            //List<Product> products= new List<Product>();
            //List must contain only <Product>s 
            //Both <BoxedProduct> and <FreshProduct> are descendants of type <Product>
